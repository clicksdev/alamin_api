...
<div class="card p-3 mb-3" id="events_wrapper">
    <div class="d-flex justify-content-between" style="gap: 16px">
        <div class="w-100">
            ...
            <div class="form-group w-100">
                ...
                @endphp
                <select name="categories" id="categories" class="form-control" multiple v-model="category_ids">
    ...
    <div class="form-group">
        <br>
        <button class="btn btn-success w-25" @click="updateEvent" style="margin: auto; display: block">Create</button>
    </div>
</div>
...
createApp({
    ...
    methods: {
        ...
        async updateEvent() {
            ...
            try {
                const response = await axios.post(`{{ route("admin.events.create") }}`, {
                    title: this.title,
