                ...
                <tbody>
                    @foreach ($categories as $cat)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route("admin.categories.edit", ["id" => $cat->id]) }}" class="btn btn-success">Edit</a>
                                <a href="{{ route("admin.categories.delete.confirm", ["id" => $cat->id]) }}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
